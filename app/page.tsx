  ...
  "@graph": [
    {
      ...
      "alternateName": ["Văn Hòa Lạc", "Van Hoa Lac Mooncake"],
      "description": "Thương hiệu bánh trung thu thủ công cao cấp tại Long Điền. Chuyên cung cấp bánh da dợp (3 lớp nhân) và bánh trung thu gà quay, thập cẩm , đậu xanh.... Giao hàng toàn quốc.",
    ...
    },
    {
      ...
      "url": "https://vanhoalac.vn",
      "name": "Bánh Trung Thu Văn Hòa Lạc",
      "description": "Thương hiệu bánh trung thu thủ công cao cấp tại Long Điền TPHCM",
    ...
    },
    {
      ...
      "url": "https://vanhoalac.vn",
      "name": "Bánh Trung Thu Văn Hòa Lạc | Bánh Trung Thu Cao Cấp Thủ Công Long Điền TPHCM",
      "isPartOf": { "@id": "https://vanhoalac.vn/#website" },
      "about": { "@id": "https://vanhoalac.vn/#business" },
      "description": "Bánh Trung Thu Văn Hòa Lạc - Thương hiệu bánh trung thu thủ công cao cấp tại Long Điền. Chuyên cung cấp bánh da dợp (3 lớp nhân) và bánh trung thu gà quay, thập cẩm , đậu xanh.... Giao hàng toàn quốc.",
